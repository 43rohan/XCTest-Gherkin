...
fileprivate func allClasses() -> [AnyClass] {
    ...
    let allClasses = UnsafeMutablePointer<Swift.AnyClass>.allocate(capacity: Int(expectedClassCount))
    let autoreleasingAllClasses = AutoreleasingUnsafeMutablePointer<Swift.AnyClass>(allClasses)  // Huh? We should have gotten this for free.
